...
function Clock() {
    ...
    const stringDay = date.toLocaleDateString('default', {weekday: 'long'}) || <br/> // пишут студенты
    const stringMonth = date.toLocaleDateString('default', {month: 'long'}) || <br/> // пишут студенты
